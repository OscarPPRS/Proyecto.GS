...
CREATE TABLE INCIDENCIAS_PALETS (
	ID_INCIDENCIA INT NOT NULL ,
	COD_PALET INT,
	DESC_INCIDENCIA varchar(500),
...
ALTER TABLE USUARIOS ADD CONSTRAINT USUARIOS_fk0 FOREIGN KEY (ID_EMPRESA) REFERENCES EMPRESAS(ID_EMPRESA);
...
ALTER TABLE INCIDENCIAS_PALETS ADD CONSTRAINT INCIDENCIAS_PALETS_fk0 FOREIGN KEY (COD_PALET) REFERENCES PALETS(COD_PALET);
...
INSERT INTO EMPRESAS VALUES (1,'ICP');

INSERT INTO EMPRESAS VALUES (2,'WORTEN');

INSERT INTO EMPRESAS VALUES (3,'XIAOMI');

-- INSERTAR EN USUARIOS

INSERT  INTO USUARIOS VALUES('usuICP',1,'Icp');

INSERT  INTO USUARIOS VALUES('usuWORTEN',2,'Worten');

INSERT  INTO USUARIOS VALUES('usuXIAOMI',3,'Xiaomi');
...
INSERT INTO ESTADOS_ORDEN_SALIDA VALUES (1,'ESPERANDO_PREPARACION');

INSERT INTO ESTADOS_ORDEN_SALIDA VALUES (2,'PICKING');

INSERT INTO ESTADOS_ORDEN_SALIDA VALUES (3,'REVISION');

INSERT INTO ESTADOS_ORDEN_SALIDA VALUES (4,'ESPERANDO_CARGA');
